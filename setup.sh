...
OPENVLA_PIN="c8f03f4"
SITE_PIN=""              # website snapshot; any recent main is fine
...
ensure_clone "openvla.github.io" "https://github.com/openvla/openvla.github.io.git" "${SITE_PIN}" "OpenVLA site" || fail=1
