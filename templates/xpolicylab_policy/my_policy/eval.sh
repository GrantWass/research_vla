#!/bin/bash
# Same-machine eval entry: policy server + sim client on localhost.
# Mirrors XPolicyLab/policy/demo_policy/eval.sh. No TODOs needed here unless
# the policy needs extra setup before serving.
set -euo pipefail
