"""Eval loop: policy server <-> RoboDojo sim client contract.

Mirrors XPolicyLab/policy/demo_policy/deploy.py. Keep as-is unless the policy
needs custom stepping (e.g. different chunk handling).
"""
